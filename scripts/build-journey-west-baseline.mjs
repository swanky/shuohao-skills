...
const specs = [
  {
    ...
    oneLiner:'以慈悲、制度與精準判斷安排取經全局，在師徒無法突破時才介入並把失序力量重新安置。', traits:['慈悲','沉著','具權威','善觀察','重因果'], temperament:'語氣溫和但決斷清楚，能先聽完陳述再指出問題根源；幫助從不等同於取消考驗。', motivation:'使取經人完成西行、讓可教化者各歸其位，並維持天界與人間的因果秩序。',
  ...
  },
  {
    ...
    arc:'她從國書接待轉為主動提親，願讓出王位與唐三藏共享國家；最終接受對方離去，留下情感與使命無法兼得的餘韻。', relationships:[['唐三藏','她真誠求婚、希望留下共治的對象'],['孫悟空','以權宜話術協助師父脫身的護法'],['女太師','代為議婚與處理朝政的重臣']], evidenceNames:['女王','西梁女國','女兒國'],
  ...
  },
  {
    ...
    visualLocal:'固定為成年東亞女性形態的古老亡靈，完整無傷的皮膚覆灰白舞台妝，以柔和陰影勾出清楚骨相，眼窩深而有冷光，仍保留可辨識的同一張臉。', costumeLocal:'穿褪灰白交領長袍與枯褐腰帶，衣料織有低調骨節抽象紋，髮絲灰黑鬆散，持一支枯木手杖；全身無傷口、無外露骨頭。',
  ...
  {
    name:'蠍子精', aliases:['蝎子精','琵琶洞女怪','毒敵山女妖'], gender:'女', age:'固定妖身外觀約三十至四十歲（推斷）', identity:'毒敵山琵琶洞的母蠍妖，以倒馬毒樁傷過如來與孫悟空',
    oneLiner:'以強大毒鉤、近戰能力與直接求偶欲望綁住唐三藏，是少數能正面壓制悟空與八戒的女妖。', traits:['強悍','自信','具侵略性','好勝','執著'], temperament:'對唐三藏刻意柔媚，對戰時毫不拖延；遭拒與被攻洞後立刻轉為壓迫性武力。', motivation:'強迫唐三藏成為伴侶並守住洞府，以自身修為與毒器壓倒反對者。',
    arc:'她擄走唐三藏並試圖成婚，能以鋼叉與毒鉤抗衡悟空、八戒；最後在昴日星官克制下現出蠍子本相而亡。', relationships:[['唐三藏','她試圖強迫結合、但始終拒絕的對象'],['孫悟空','被倒馬毒刺傷並求援的主要對手'],['昴日星官','以天敵之聲逼她現形死亡者']], evidenceNames:['蝎子精','倒馬毒','毒敵山琵琶洞'],
    visualLocal:'約三十五歲的東亞女性蠍妖固定人形，窄長臉、目光銳利，身形強健，後腰連接一條可動實體蠍尾，前臂有低調黑褐甲殼。', costumeLocal:'穿深紫黑窄袖戰袍、暗紅護腰與分片裙甲，持三股鋼叉，黑褐甲殼尾鉤從背後完整可見，穿硬皮戰靴。',
  ...
  },
  {
    ...
    arc:'她把真公主拋入荒野後冒名生活，拋繡球選中唐三藏；戰敗現出玉兔來歷，最後由太陰星君帶回月宮。', relationships:[['太陰星君','最終前來收回她的月宮主人'],['唐三藏','她企圖招為駙馬的對象'],['天竺真公主','被她報復、取代身分的素娥轉世']], evidenceNames:['玉兔兒','搗藥杵','蟾宮之內'],
  ...
  },
  {
    ...
    oneLiner:'以地下洞府、替身遺骸與反覆變化拖延追兵，把求婚與吞食企圖藏在精密逃脫路線中。', traits:['機警','擅逃遁','善偽裝','執著','會利用名號'], temperament:'面對唐三藏柔聲周旋，遇追捕立即切換替身與地道；壓力越大越依賴假身份。', motivation:'占有唐三藏並藉其元陽增進修為，同時利用天界義親名號逃避追究。',
    arc:'她先在鎮海寺害僧，再擄唐三藏入無底洞，多次以替身與變化脫逃；悟空查出供奉牌位後由李天王、哪吒收伏。', relationships:[['唐三藏','她擄入洞府並企圖婚配的目標'],['孫悟空','追入無底洞、查出其天界關係的對手'],['托塔李天王','被她供作義父、最後奉旨收伏她的人']], evidenceNames:['地湧夫人','金鼻白毛老鼠精','半截觀音'],
  ...
  },
  {
    ...
    arc:'從高老莊被收伏加入西行，屢次提出散伙、誤會悟空或受誘惑，卻也在水戰與搬山等任務中不可替代，最終受封淨壇使者。', relationships:[['孫悟空','互相嘲弄、競爭又依賴的師兄'],['唐三藏','既服從又常用抱怨影響的師父'],['沙悟淨','共同挑擔、作戰並承受師兄壓力的同伴']], evidenceNames:['豬八戒','豬悟能','八戒'],
  ...
  },
  {
    ...
    oneLiner:'以沉默耐力、秩序感與穩定戰力維持隊伍，是爭吵與危機之間最可靠的承重結構。', traits:['沉穩','忠誠','耐苦','少言','重秩序'], temperament:'很少搶話，通常先做再報告；師兄衝突時多勸回任務本身，真正動怒時語句短而沉。', motivation:'贖回天界失職之罪，完成護送責任並維持師徒隊伍不致散裂。',
    arc:'他從流沙河食人妖被觀音收伏，加入後長期負重、守師與水戰；個人戲份較少，卻以持續可靠完成修行。', relationships:[['唐三藏','長期近身守護並承擔行李的師父'],['孫悟空','服從其戰術、也會調停衝突的師兄'],['豬八戒','共同作戰與抬擔、性格互補的師兄']], evidenceNames:['沙悟淨','沙僧','悟淨'],
  ...
  },
  {
    ...
    visualLocal:'外貌約五十五歲的東亞男性佛陀形象，圓闊臉、眉眼沉靜，短捲髮髻與頭頂肉髻採克制實體妝效，體態寬厚。', costumeLocal:'穿赭金與暗紅層疊袈裟，織低調法輪紋，赤足坐於簡潔蓮座，手作施無畏印，不配武器。',
  ...
  },
  {
    ...
    oneLiner:'以巨大力量、妖界人脈與家族關係維持多處領地，卻在婚姻裂痕與借扇衝突中被各方圍攻。', traits:['強悍','自負','重面子','善交遊','感情失序'], temperament:'平時豪飲結交、講究身份，受挑戰後直接以力量回應；對妻妾衝突多逃避而非調停。', motivation:'保住領地、名聲與自主生活，不讓天界或舊友把家族法寶當成可隨意調用之物。',
  ...
  },
  {
    ...
    oneLiner:'把被懲罰的龍族身分收束為長途負重與沉默護送，只有關鍵危局才重新顯露變化與戰力。', traits:['沉默','耐苦','忠於任務','克制','具隱藏戰力'], temperament:'日常以動作而非言語回應，對驚嚇與飢渴有真實動物反應；化龍或人形出戰時則果斷。', motivation:'贖回縱火毀珠之罪，完成護送取經人的職責並重返天界秩序。',
    ...
    voice:{timbre:'低沉克制的成年雄性非語言聲響',pitch:'中低音',pace:'平時以呼吸與短嘶回應，危機時急促',accent:'不適用人類口音',emotion:'耐苦、警醒、忠誠',hint:'以真實馬匹的鼻息、低嘶與蹄步表達，不作人類台詞',en:'An adult male equine nonverbal voice, low-mid register, restrained breath, soft snorts and brief neighs, steady travel rhythm accelerating only in danger; no spoken human language.',local:'成年雄性龍馬的非語言聲響，音域中低；以呼吸、短嘶與蹄步表達耐苦和警醒，不說人類台詞。'}
  },
  {
    ...
    arc:'他在天庭圍捕中以變化對變化追逼悟空，後來亦在取經路上受請協助降妖；從敵手成為可調用的高階盟友。', relationships:[['孫悟空','變化與武藝旗鼓相當、由敵轉為可合作的對手'],['梅山六兄弟','長期協同追獵與作戰的部屬伙伴'],['玉皇大帝','接受調遣但保有灌江口獨立性的天界上位者']], evidenceNames:['二郎神','二郎顯聖','顯聖二郎真君'],
...
const cast = {
  ...
  lang: 'zh-TW',
  style: 'photoreal',
  summary: '取經使命把反叛石猴、凡人僧侶、被貶神將與龍族罪人綁成一支不穩定卻持續前行的隊伍。沿途的女性君主、妖王與菩薩不是單一誘惑類型：她們掌握國家、法寶、洞府、毒器、身份與制度權力，也以家族、舊怨、修行與欲望推動不同劫難。本角色群像以八位主要女性和八位核心補充角色呈現師徒關係、神魔秩序與性別權力的交織。',
