...
const redChamberSpecs = [
  {
    ...
    relationships: [{name:'林黛玉',relation:'精神知己與情感核心'}, {name:'薛寶釵',relation:'家族期待的婚姻對象與價值觀映照'}, {name:'賈母',relation:'最主要的保護者與祖母'}, {name:'賈政',relation:'以仕途和家法要求他的父親'}, {name:'襲人',relation:'貼身照料生活並勸其入世的侍女'}],
    evidencePatterns: ['何等眼熟到如此', '面若中秋之月', '原來草莽．潦倒不通世務', '女儿是水作的骨肉'],
    ...
    costumeLocal: '穿銀紅與朱紅層疊絲袍，暗織克制的金線雲紋，配淡玉腰飾、黑色軟靴與胸前多彩玉佩。', paletteLocal: '銀紅、朱紅與淡玉配色', detailsEn: 'the multicoloured jade pendant, silver-red woven silk and cloud embroidery, the refined topknot ornament, pale jade belt fitting, soft black cloth boot', negativeEn: 'adult beard, muscular warrior body, imperial dragon crown, modern haircut, feminine makeup',
...
function buildJinPingMei() {
  ...
  const cast = {
    ...
    lang: 'zh-TW',
    style: 'photoreal',
    summary: '晚明商業城市清河縣中，西門慶以財富、官場關係與婚姻網路擴張勢力，妻妾、僕役、幫閒與地方人物因而被捲入同一座宅院及其外部交易。潘金蓮、李瓶兒、吳月娘、龐春梅等女性在內宅權力、情感需求與生存策略之間各自行動，武松、陳經濟、應伯爵等男性則從復仇、依附與欲望的不同位置介入。這十九人共同呈現財富如何轉化為親密控制與社會權力，也讓日常宴飲、帳務和往來成為人物命運交錯的場域。',
    characters,
  };
  fs.mkdirSync(outDir, {recursive: true});
