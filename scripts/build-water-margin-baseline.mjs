...
const specs = [
  {
    ...
    voice:{timbre:'清冷結實的年輕女中音',pitch:'中音',pace:'短句、節拍明確',accent:'山東地方語感（推斷）',emotion:'剋制而警醒',hint:'像一位在馬背上用最少口令完成換陣的女將',en:'A young adult female mezzo voice, mid pitch, firm clear tone, restrained Shandong colouring, short tactical phrases and controlled alertness without flirtation.',local:'約二十三歲的女中音，音高居中、聲線清冷結實；帶山東語感，句子短而有戰術節拍，情緒剋制警醒。'}
  },
  {
    name:'孫二孃', aliases:['母夜叉'], gender:'女', age:'約三十至四十歲（推斷）', identity:'十字坡酒店女店主、張青之妻，後為梁山頭領',
    ...
    arc:'從試圖麻倒武松的黑店主人轉為結義同道，最後把地方性的生存手段帶入梁山體系。', relationships:[['張青','共同經營酒店的丈夫'],['武松','由衝突轉為互相承認的江湖同道'],['魯智深','曾在十字坡落入其店中的頭領']], evidenceNames:['孫二孃','母夜叉'],
  ...
  },
  {
    ...
    oneLiner:'能把親族、酒店與武力迅速組織成營救網路的強悍女頭領，行事比孫二孃更直接、更具號召力。', traits:['豪爽','有組織力','勇決','護親','直率'],
  ...
  },
  {
    ...
    oneLiner:'以書信秘密與宋江談判、要求掌握自身利益的年輕女性，強硬選擇把兩人推向致命衝突。', traits:['聰明','強硬','善談判','現實','不服輸'],
    temperament:'口齒快、抓住把柄便反覆加碼，不願以感恩抵銷自己的要求；在危險升高時仍不肯退讓。', motivation:'擺脫不滿的依附關係，取得財物與選擇情感物件的自由。',
  ...
  },
  {
    ...
    oneLiner:'在疏離婚姻中尋求情感與慾望、又以謊言維持雙重生活的女性，最終被捲入極端私刑。', traits:['善應變','隱秘','情感強烈','自我保護','矛盾'],
    temperament:'平時能維持家中禮數，被質疑時迅速編造說詞；她的恐懼與執拗並存，分析不替後續暴力合理化。', motivation:'在不滿的婚姻生活中尋找情感滿足，同時保住家庭身分與秘密。',
    arc:'私情被石秀察覺後，她以辯解挑動楊雄與石秀決裂；真相揭開後，男性結義與私刑把她推向暴力結局。', relationships:[['楊雄','婚姻疏離並最終施以私刑的丈夫'],['石秀','察覺私情並追查證據的人'],['裴如海','秘密往來的僧人']], evidenceNames:['潘巧雲','巧雲'],
    ...
    voice:{timbre:'柔暗而緊繃的成年女中音',pitch:'中音',pace:'日常剋制，辯解時變快',accent:'薊州城市口音（推斷）',emotion:'防衛、焦慮、偶爾強硬',hint:'像一位努力讓每句辯解聽起來仍屬日常家務的妻子',en:'An adult female mezzo voice, mid pitch, soft dark timbre under tension, Jizhou urban colouring, controlled domestic cadence that accelerates under accusation, defensive anxiety with flashes of resolve.',local:'約二十八歲的柔暗女中音，音高居中而聲線緊繃；帶薊州城市語感，平時剋制，受到質問時加快，防衛焦慮中偶爾強硬。'}
  },
  {
    name:'王婆', aliases:[], gender:'女', age:'約五十五至六十五歲（推斷）', identity:'陽穀縣賣茶老婦與媒合者，策動西門慶、潘金蓮私情',
    oneLiner:'熟悉街坊慾望與弱點的茶坊老婦，把媒合、試探和勒索拆成一套可執行步驟。', traits:['世故','善算計','口才好','觀察敏銳','逐利'],
    temperament:'先用閒談探底，再以看似幫忙的方式提高依賴；危機來臨時仍試圖靠話術改寫責任。', motivation:'把街坊秘密與人情轉成收入和影響力，確保自己在地方關係網中的位置。',
  ...
  },
  {
    ...
    oneLiner:'在權勢騷擾與丈夫遭陷害的壓力下維持拒絕與尊嚴，其處境揭露東京權貴對平民家庭的侵害。', traits:['堅貞','警醒','剋制','有尊嚴','重感情'],
    ...
    voice:{timbre:'清柔而有底氣的成年女中音',pitch:'中音',pace:'禮貌緩慢，拒絕時清楚加重',accent:'東京城市家庭語感（推斷）',emotion:'剋制、警惕、受壓仍不失尊嚴',hint:'像一位面對權貴糾纏仍把拒絕說得完整清楚的教頭妻子',en:'An adult female mezzo voice, mid pitch, clear gentle tone with inner firmness, Kaifeng urban household diction, measured courtesy and unmistakable emphasis when refusing coercion.',local:'約三十歲的清柔女中音，音高居中而有底氣；東京城市家庭語感，平時禮貌緩慢，拒絕逼迫時咬字清楚加重。'}
  },
  {
    ...
    arc:'從地方押司因私放晁蓋、怒殺閻婆惜而流亡，逐步成為梁山領袖；聚義擴大之際，他也把招安願望帶入山寨政治。', relationships:[['吳用','共同決策與排程的軍師'],['李逵','忠誠激烈、也需他約束的部下'],['盧俊義','被迎入梁山並共同承擔領袖位置的人']], evidenceNames:['宋江','公明','及時雨','呼保義'],
    ...
    voice:{timbre:'溫厚沉穩的成年男中音',pitch:'中低音',pace:'平時從容，排程時節奏緊密',accent:'鄆城文吏官話帶山東語感（推斷）',emotion:'謙和、審慎，談名分時格外堅定',hint:'像一位能先安撫全席、再讓每個人接受同一項決策的地方領袖',en:'A mature male baritone, low-mid pitch, warm controlled resonance, Shandong clerkly vernacular, measured social cadence that tightens into command, humility layered over political resolve.',local:'約四十歲的溫厚男中音，音高偏中低，帶山東文吏語感；平時從容周全，排程時節奏緊密，謙和下藏政治決心。'}
  },
  {
    ...
    visualLocal:'北宋山東約四十歲的漢族寒士軍師，瘦長臉、細眼、短鬚，身形清瘦，神情安靜而持續觀察。', costumeLocal:'穿灰青布袍、米白內衫與黑色軟巾，腰掛簡樸算袋，手持摺扇與卷冊，穿灰黑布鞋。',
  ...
  },
  {
    ...
    oneLiner:'長期忍讓制度與權勢侵害的禁軍教頭，當退路被徹底切斷才把剋制轉成決絕反抗。', traits:['武藝精熟','忍耐','重情','謹慎','決絕'],
    ...
    voice:{timbre:'剋制厚實的成年男中音',pitch:'中低音',pace:'平時慢，決斷時短促',accent:'東京軍職官話（推斷）',emotion:'壓抑、警戒，爆發後冰冷',hint:'像一位把怒氣壓到最後一步才出手的正規教頭',en:'A mature male baritone, low-mid pitch, controlled solid tone, Kaifeng military diction, slow restraint that becomes clipped and cold at the point of decision.',local:'約三十五歲的厚實男中音，音高偏中低，帶東京軍職官話；平時剋制偏慢，決斷時縮成短句，壓抑轉為冰冷。'}
  },
  {
  ...
  },
  {
    ...
    arc:'從景陽岡打虎成名、任陽穀都頭，到查明兄長死因並復仇；孟州與鴛鴦樓事件後改作行者，走上梁山。', relationships:[['武植','促使他追查與復仇的兄長'],['潘金蓮','試探他並參與殺害武植的人'],['孫二孃','由衝突轉為結義的十字坡店主']], evidenceNames:['武松','武二郎','行者'],
  ...
  },
  {
    ...
    oneLiner:'把忠誠、怒氣與破壞力毫無遮掩地放在行動上的猛將，既能護主也常造成難以收拾的傷害。', traits:['勇猛','直率','暴躁','忠於宋江','缺乏剋制'],
...
const cast = {
  ...
  lang: 'zh-TW',
  style: 'photoreal',
  summary: '北宋末年的山東、河北與東京一帶，官府壓迫、地方豪強與個人恩怨把各種身分的人逐步推向江湖。宋江、吳用等人以人情與計策擴大梁山，林沖、魯智深、武松、楊志等武人則從各自遭遇走上同一座山寨。扈三娘、孫二孃、顧大嫂等女性以戰鬥、經營與組織能力介入這個群體，潘金蓮、閻婆惜、潘巧雲與林娘子的故事則揭露家庭、權勢與暴力如何和江湖秩序交纏。這份角色群像只涵蓋本目錄收錄的楔子至第七十回。',
