...
scripts/
  ...
  selftest.mjs           399 assertions, never calls a model
references/
...
399 assertions across chunking, alias merging, outline seeding, assembly, localization, style and prompt consistency, validation, and rendering. No model calls, no quota, runs in about a second. Run it before anything else after touching the scripts.
